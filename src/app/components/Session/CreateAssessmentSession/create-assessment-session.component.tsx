...
// Data
import { ICreateAssessmentSession } from './create-assessment-session.interface';
import messages from './create-assessment-session.messages';
...
const CreateSession: React.FC<ICreateAssessmentSession> = ({
  form,
  submitError,
  showSaved,
  createAgeGroup,
