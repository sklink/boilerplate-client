...
export const SESSION_TERM = 'Ice Time';
export const SESSIONS_TERM = 'Ice Times';
...
export const SKILL_TYPE_MAP: any = {
  SCORE: 'Numbered Score',
  TIMED: 'Timed Score (Stopwatch)'
};
export const SKILL_TYPE_OPTIONS = _.map(SKILL_TYPE_MAP, (label, value) => ({ value, label }));
